...
METHOD EditCreate() CLASS DlgAutoEdit
   ...
   LOCAL nRow, nCol, aItem, oTab := Nil, nPageCount := 0, nLen, aList := {} //, oPanel
...
*/
         ...
         END LABEL
         cText := "Text" + Ltrim( Str( aItem:__EnumIndex ) )
         @ nRow2, nCol2 TEXTBOX &( cText ) ;
            OF ::oDlg ;
            HEIGHT 20 ;
